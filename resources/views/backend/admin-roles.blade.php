...
@section('body_content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Admin Roles</h1>
        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach($roles as $role)
                                        <tr class="warning">
                                            ...
                                            <td>
                                                @if(!in_array(\Session::get('admin_role'), ['super-admin']) && in_array($role->role, ['super-admin']))
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            @if($role->status == 'active')
                                                                <a class="dropdown-item btn-sm" style="cursor:pointer" href="{{url('admin/role-deactivate', $role->id)}}">Deactivate</a>
                                                            @else
                                                                <a class="dropdown-item btn-sm" style="cursor:pointer" href="{{url('admin/role-activate', $role->id)}}">Re-activate</a>
                                                            @endif
        ...
        <div class="modal fade" id="editModal{{$role->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form id="credit-form" action="{{url('/admin/edit-role', $role->id)}}" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label for="amount">Role Slug</label>
        ...
        <div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="credit-form" action="{{url('/admin/create-role')}}" method="post">
                        <div class="modal-body">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <div class="row">
