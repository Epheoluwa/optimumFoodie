...
<!-- <section>
    <div class="container">
        <h2 class="head2">Yaaay! Your FREE Meal Plan is ready!</h2>
        <img src="{{ url('assets/frontend/images/happyboy.png') }}" class="img-responsive" style="max-height:200px;" />
        <h1 class="head1">We’ve just created your fully CUSTOMIZED 4 week meal plan!</h1>

        <div style="display:flex;align-items:center;justify-content:center;justify-items:center;min-height:60%;">

            <div style="display:inline-block;" align="center">
                <button class="btn btn-dark-outline whom-btn" onclick="">Send me my FREE PLAN!</button>
            </div>
        </div>
    </div>
</section> -->